...
3) The previous executions results ($r_1, r_2, ..., r_t-1$) from the "Executor"
...
If you want to search, filter, or sort, you can put the condition in your plan. For example, if the query is "Who is the lead actor of In the Mood for Love (id 843)", instead of "Get the list of actors of In the Mood for Love", you should output "Get the lead actor of In the Mood for Love (843)".
